...
$sql = "INSERT INTO `userJobList`(`jobTitle`, `jobType`, `jobPrice`, `jobLocation`, `jobWorkingHours`, `jobDescription`, `jobMobileNumber`, `jobEmail`,`imageUrl`,  `dateTimeStart`, `dateTimeEnd`) VALUES ('$jobTitle', '$jobType', '$jobPrice', '$jobLocation', '$jobWorkingHours', '$jobDescription', '$jobMobileNumber', '$jobEmail', '$imageUrl', '$dateTimeStart','$dateTimeFinish')";
